...
export function GroupChip({ group }: Props) {
  ...
  return (
    <span className="inline-flex max-w-48 shrink-0 items-center gap-1.5 rounded-md bg-slate-50 px-2 py-0.5 text-xs text-slate-700 ring-1 ring-inset ring-slate-200">
